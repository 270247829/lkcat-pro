                    ...
                    <Row>
                        <Col span="12">
                            <Card dis-hover>
                                ...
                                <div style="height: 360px;">
                                    <ul id="doList" class="lkcat-admin-draggable-list"></ul>
                                </div>
                            </Card>
                        </Col>
                        <Col span="12" class="padding-left-10">
                            <Card dis-hover>
                                ...
                                <div style="height: 360px;">
                                    <ul id="todoList" class="lkcat-admin-draggable-list">
            ...
            <Col span="8" class="padding-left-10">
                <Card>
                    ...
                    <div style="height: 394px;">
                        <ul class="lkcat-admin-draggable-list">
                ...
                <Card>
                    ...
                    <Row>
                        <Col span="12">
                            <Card dis-hover>
                                <div style="height: 360px;">
                                    <ul id="affordList" class="lkcat-admin-draggable-list"></ul>
                                </div>
                            </Card>
                        </Col>
                        <Col span="12" class="padding-left-10">
                            <Card dis-hover>
                                <div style="height: 360px;">
                                    <ul id="shoppingList" class="lkcat-admin-draggable-list">
...
export default {
    ...
    data () {
        return {
            todoArray: [
                {
                    content: '完成lkcat-admin基本开发'
                },
                {
                    content: '对lkcat-admin进行性能优化'
                },
                {
                    content: '对lkcat-admin的细节进行优化'
                },
                {
                    content: '完成lkcat-admin开发'
                },
                {
                    content: '解决发现的bug'
                },
    ...
    mounted () {
        ...
        Sortable.create(todoList, {
            ...
            fallbackClass: 'lkcat-admin-cloned-item',
            onRemove (event) {
        ...
        Sortable.create(doList, {
            ...
            sort: false,
            filter: '.lkcat-admin-draggable-delete',
            animation: 120,
            fallbackClass: 'lkcat-admin-cloned-item',
            onRemove (event) {
